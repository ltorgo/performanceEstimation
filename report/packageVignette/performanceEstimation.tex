...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{powErr} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{itResults}\hlstd{,}\hlkwc{stats}\hlstd{,}\hlkwc{pow}\hlstd{=}\hlnum{3}\hlstd{) \{}
    \hlkwa{if} \hlstd{(stats} \hlopt{!=} \hlstr{"pow.err"}\hlstd{)} \hlkwd{stop}\hlstd{(}\hlstr{"Unable to calculate that metric!"}\hlstd{)}
    \hlkwd{c}\hlstd{(}\hlkwc{pow.err} \hlstd{=} \hlkwd{mean}\hlstd{((itResults}\hlopt{$}\hlstd{trues}\hlopt{-}\hlstd{itResults}\hlopt{$}\hlstd{preds)}\hlopt{^}\hlstd{pow))}
\hlstd{\}}
\end{alltt}
\end{kframe}
\end{knitrout}
